...
public class AlertLogoutFragment extends DialogFragment {
    ...
    private AlertLogoutCallback mListener;
    private Context context;
    private String header = "", textOk = "", textCancel = "";
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof Activity) {
            a = (Activity) context;
            try {
                this.mListener = (AlertLogoutCallback) a;
    ...
    public void onClick(View v) {
        if (v.equals(okTV)) {
            mListener.onLogoutCallback(true);
            this.dismiss();
    ...
    /**
     * The interface Alert logout callback.
     */
    public interface AlertLogoutCallback {
        /**
         * On logout callback.
         *
         * @param value the value
         */
        void onLogoutCallback(boolean value);
    }
}
