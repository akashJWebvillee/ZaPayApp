...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.mipmap.ic_star_fill;
    private int mStarOffResource = R.mipmap.ic_star_hollow;
    private int mStarHalfResource = R.mipmap.ic_star_fill;
