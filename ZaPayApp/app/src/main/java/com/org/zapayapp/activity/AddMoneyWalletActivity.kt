...
import com.org.zapayapp.alert_dialog.SimpleAlertFragment.AlertSimpleCallback
...
class AddMoneyWalletActivity : AppCompatActivity() ,View.OnClickListener, APICallback, AlertSimpleCallback{
    ...
    private fun apiCodeInit() {
        ...
        wValidationLib = WValidationLib(this@AddMoneyWalletActivity)
    }
    ...
    private fun amountAddFunc(){
        ...
        try {
            ...
            if (apiCalling != null) {
                apiCalling!!.callAPI(zapayApp, call, getString(R.string.api_add_withdrawal_balance_in_wallet), addTV)
            }
        } catch (e: Exception) {
            e.printStackTrace()
        }
